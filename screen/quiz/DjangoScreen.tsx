                            ...
                            <View style={tailwind`flex-1`}>
                                ...
                                {!startQuiz ?
                                    <View style={tailwind`flex-1 justify-center`}>
                                        <Text style={[tailwind`pt-4 px-3 text-[16px] text-center mt-[-100px]`, { color, fontFamily: 'Lato-Regular' }]}>Answer Ten questions in 4 minutes. Time starts when you click "Start Quiz." No going back after clicking "Next," so answer quickly.</Text>
...
export default DjangoQuizScreen
